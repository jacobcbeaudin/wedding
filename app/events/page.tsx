    ...
    <CoastalLayout>
      <div className="container mx-auto max-w-5xl px-6 py-12 sm:py-20">
        <div className="mb-12 text-center sm:mb-16">
          ...
          <p className="text-muted-foreground text-base sm:text-lg">A weekend of celebration</p>
        </div>
          ...
          <Card className="coastal-shadow border-0 p-6 sm:p-8">
            <div className="grid gap-4 sm:gap-6 md:grid-cols-4">
              <div className="text-center md:text-left">
                ...
                />
                <div className="elegant-serif text-primary text-2xl sm:text-3xl">Tea Ceremony</div>
              </div>
              <div className="md:col-span-3">
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex flex-col sm:flex-row sm:gap-8">
                    <span className="text-foreground min-w-[120px] font-medium">Date & Time:</span>
                    <span className="text-muted-foreground">
                      Thursday, September 11, 2026 at 2:00 PM
                    </span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:gap-8">
                    <span className="text-foreground min-w-[120px] font-medium">Location:</span>
                    <span className="text-muted-foreground">Garden Pavilion</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:gap-8">
                    <span className="text-foreground min-w-[120px] font-medium">Dress Code:</span>
                    <span className="text-muted-foreground">Semi-formal / Cocktail attire</span>
                  </div>
                  <p className="text-foreground pt-3 text-sm leading-relaxed sm:pt-4 sm:text-base">
                  ...
                  <p className="text-muted-foreground pt-2 text-xs italic sm:pt-3 sm:text-sm">
            ...
            <div className="grid gap-4 sm:gap-6 md:grid-cols-4">
              <div className="text-center md:text-left">
                <Image
                  ...
                  className="mx-auto mb-4 h-20 w-20 sm:h-28 sm:w-28 md:mx-0"
                />
                <div className="elegant-serif text-primary text-2xl sm:text-3xl">Welcome Party</div>
              </div>
              <div className="md:col-span-3">
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex flex-col sm:flex-row sm:gap-8">
            ...
            <div className="grid gap-4 sm:gap-6 md:grid-cols-4">
              <div className="text-center md:text-left">
                <Image
                  ...
                  className="mx-auto mb-4 h-20 w-20 sm:h-28 sm:w-28 md:mx-0"
                />
                <div className="elegant-serif text-primary text-2xl sm:text-3xl">Wedding Day</div>
              </div>
              <div className="md:col-span-3">
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex flex-col sm:flex-row sm:gap-8">
                    <span className="text-foreground min-w-[120px] font-medium">Date:</span>
                    <span className="text-muted-foreground">Friday, September 12, 2026</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:gap-8">
                    <span className="text-foreground min-w-[120px] font-medium">Ceremony:</span>
                    <span className="text-muted-foreground">4:00 PM</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:gap-8">
                    <span className="text-foreground min-w-[120px] font-medium">
                      Cocktail Hour:
                    </span>
                    <span className="text-muted-foreground">5:00 PM - 6:00 PM</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:gap-8">
                    <span className="text-foreground min-w-[120px] font-medium">Reception:</span>
        ...
        <Card className="bg-secondary/30 mt-8 border-0 p-6 sm:mt-12 sm:p-8">
          <h2 className="elegant-serif text-primary mb-4 text-center text-xl sm:mb-6 sm:text-2xl">
            Weekend Timeline
          </h2>
          <div className="space-y-3 text-sm sm:space-y-4 sm:text-base">
            <div className="border-border flex flex-col items-start justify-between border-b pb-3 sm:flex-row sm:items-center">
              <span className="text-foreground font-medium">Thursday, Sept 11 &bull; 2:00 PM</span>
              <span className="text-muted-foreground">
                Tea Ceremony <span className="text-xs italic">(family only)</span>
              </span>
            </div>
            <div className="border-border flex flex-col items-start justify-between border-b pb-3 sm:flex-row sm:items-center">
              <span className="text-foreground font-medium">Thursday, Sept 11 &bull; 7:00 PM</span>
              <span className="text-muted-foreground">Welcome Party</span>
            </div>
            <div className="border-border flex flex-col items-start justify-between border-b pb-3 sm:flex-row sm:items-center">
              <span className="text-foreground font-medium">Friday, Sept 12 &bull; 4:00 PM</span>
              <span className="text-muted-foreground">Ceremony</span>
            </div>
            <div className="border-border flex flex-col items-start justify-between border-b pb-3 sm:flex-row sm:items-center">
              <span className="text-foreground font-medium">Friday, Sept 12 &bull; 5:00 PM</span>
            ...
            <div className="flex flex-col items-start justify-between pb-3 sm:flex-row sm:items-center">
              <span className="text-foreground font-medium">Friday, Sept 12 &bull; 6:00 PM</span>
